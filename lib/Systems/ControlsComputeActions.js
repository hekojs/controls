...
var _SideWalkJumpControl = _interopRequireDefault(require("../Components/SideWalkJumpControl"));
...
var ControlsComputeActions = /*#__PURE__*/function (_Heko$System) {
  ...
  _createClass(ControlsComputeActions, [{
    ...
    key: "handleWithSideWalkJumpControl",
    value: function handleWithSideWalkJumpControl(entities) {
      entities.forEach(function (entity) {
        var control = entity.getComponent(_SideWalkJumpControl["default"]);
        var physics = entity.getComponent(_dPhysics["default"].Components.Physics); // TODO
...
ControlsComputeActions.queries = {
  ...
  withSideWalkJumpControl: {
    components: [_dPhysics["default"].Components.Physics, _SideWalkJumpControl["default"]]
  }
};